...
export class Backend implements backendInterface {
    ...
    async addPrediction(arg0: PredictionHistory): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addPrediction(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllPredictions(): Promise<Array<PredictionHistory>> {
        if (this.processError) {
            try {
